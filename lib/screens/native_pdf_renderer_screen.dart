...
class NativePdfRendererScreen extends StatelessWidget {
  const NativePdfRendererScreen({Key? key}) : super(key: key);

  Future<PdfDocument> _getDocument() async {
    if (await hasPdfSupport()) {
      return PdfDocument.openAsset('assets/bjitic_19060_4070_A122-801136-XS_43339_655099.pdf');
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('NativePdfRendererScreen'),
      ),
      body: FutureBuilder(
        future: _getDocument(),
